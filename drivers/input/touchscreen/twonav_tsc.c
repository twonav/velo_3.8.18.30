...
static int __init tsc_raspi_init(void)
{
	...
	printk("twonav_tsc: INIT END. irq: %u0", raspi_board_info.irq);
...
MODULE_AUTHOR("Eric Bosch <ebosch@twonav.com>");
MODULE_DESCRIPTION("Velo TSC2007 Platform Data");
MODULE_LICENSE("GPL");
