...
MODULE_ALIAS("usb:v13D3p3388d*dc*dsc*dp*ic*isc*ip*in*");
MODULE_ALIAS("usb:v13D3p3389d*dc*dsc*dp*ic*isc*ip*in*");
MODULE_ALIAS("usb:v413Cp8197d*dc*dsc*dp*ic*isc*ip*in*");
MODULE_ALIAS("usb:v413Cp8143d*dc*dsc*dp*ic*isc*ip*in*");
MODULE_ALIAS("usb:v04CAp2007d*dc*dsc*dp*ic*isc*ip*in*");
...
MODULE_INFO(srcversion, "EB385AF14C0674DC48C6B2E");
