...
enum exynos4210_gpio_number {
	EXYNOS4210_GPIO_E0_START	= EXYNOS_GPIO_NEXT(EXYNOS4_GPIO_Z),
	...
	EXYNOS4210_GPIO_J0_START	= EXYNOS_GPIO_NEXT(EXYNOS4210_GPIO_E4),
	EXYNOS4210_GPIO_J1_START	= EXYNOS_GPIO_NEXT(EXYNOS4210_GPIO_J0),
};

enum exynos4212_gpio_number {
	EXYNOS4212_GPIO_J0_START	= EXYNOS_GPIO_NEXT(EXYNOS4_GPIO_Z),
	EXYNOS4212_GPIO_J1_START	= EXYNOS_GPIO_NEXT(EXYNOS4212_GPIO_J0),
	EXYNOS4212_GPIO_M0_START	= EXYNOS_GPIO_NEXT(EXYNOS4212_GPIO_J1),
	EXYNOS4212_GPIO_M1_START	= EXYNOS_GPIO_NEXT(EXYNOS4212_GPIO_M0),
	EXYNOS4212_GPIO_M2_START	= EXYNOS_GPIO_NEXT(EXYNOS4212_GPIO_M1),
	EXYNOS4212_GPIO_M3_START	= EXYNOS_GPIO_NEXT(EXYNOS4212_GPIO_M2),
	EXYNOS4212_GPIO_M4_START	= EXYNOS_GPIO_NEXT(EXYNOS4212_GPIO_M3),
	EXYNOS4212_GPIO_V0_START	= EXYNOS_GPIO_NEXT(EXYNOS4212_GPIO_M4),
	EXYNOS4212_GPIO_V1_START	= EXYNOS_GPIO_NEXT(EXYNOS4212_GPIO_V0),
	EXYNOS4212_GPIO_V2_START	= EXYNOS_GPIO_NEXT(EXYNOS4212_GPIO_V1),
	EXYNOS4212_GPIO_V3_START	= EXYNOS_GPIO_NEXT(EXYNOS4212_GPIO_V2),
	EXYNOS4212_GPIO_V4_START	= EXYNOS_GPIO_NEXT(EXYNOS4212_GPIO_V3),
};
